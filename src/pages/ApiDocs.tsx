...
const ENDPOINTS = [
  ...
  },
  {
    ...
    method: "POST",
    description: "Buy airtime through Ikonect using a server-priced product.",
    price: API_ACTION_PRICES.vtu_airtime,
    body: { action: "vtu_airtime", product_id: "PRODUCT_UUID", phone: "08011111111", amount: 500 },
    response: {
      success: true,
      message: "Airtime purchase completed.",
      provider_reference: "VTU...",
    },
  },
  {
    id: "vtu_data_catalog",
    name: "Mobile Data Catalog",
    method: "POST",
    description: "Fetch Ikonect's live mobile data plans with the standard 4% retail markup applied.",
    price: API_ACTION_PRICES.vtu_data_catalog,
    body: { action: "vtu_data_catalog", network: "mtn" },
    response: {
      success: true,
      dataPlans: [
        {
  ...
  {
    id: "vtu_data",
    name: "Mobile Data Purchase",
    method: "POST",
    description: "Buy mobile data through Ikonect using a plan id returned by the live data catalog.",
    price: API_ACTION_PRICES.vtu_data,
    body: { action: "vtu_data", provider_plan_id: "PLAN_ID", phone: "08065849433" },
    response: {
      success: true,
  ...
  {
    id: "vtu_tv_verify",
    name: "TV Smartcard Verification",
    method: "POST",
    description: "Verify a DStv, GOtv, or Startimes smartcard through Ikonect.",
    price: API_ACTION_PRICES.vtu_tv_verify,
    body: { action: "vtu_tv_verify", provider: "dstv", smartcard_number: "1212121212" },
    response: {
      success: true,
      verified: true,
  ...
  },
  {
    ...
    method: "POST",
    description: "Pay for a TV subscription through Ikonect using a configured TV product.",
    price: API_ACTION_PRICES.vtu_tv,
    body: { action: "vtu_tv", product_id: "PRODUCT_UUID", smartcard_number: "1212121212", phone: "08105314004" },
    response: {
      success: true,
      message: "TV subscription completed.",
      provider_reference: "VTU...",
    },
  },
  {
    id: "vtu_electricity_verify",
    name: "Electricity Meter Verification",
    method: "POST",
    description: "Verify an electricity meter through Ikonect.",
    price: API_ACTION_PRICES.vtu_electricity_verify,
    body: { action: "vtu_electricity_verify", disco: "ikeja", meter_number: "1111111111111", meter_type: "prepaid" },
    response: {
      success: true,
      verified: true,
      customer_name: "JOHN DOE",
  ...
  },
  {
    ...
    method: "POST",
    description: "Pay an electricity bill through Ikonect using a configured disco product.",
    price: API_ACTION_PRICES.vtu_electricity,
    body: { action: "vtu_electricity", product_id: "PRODUCT_UUID", meter_number: "1111111111111", meter_type: "prepaid", amount: 1000, phone: "08105314004" },
    response: {
      success: true,
      message: "Electricity payment completed.",
      provider_reference: "VTU...",
    },
  },
  {
