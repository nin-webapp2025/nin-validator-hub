...
export function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 border-t border-slate-200/80 dark:border-slate-800 mt-auto overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-100/20 via-transparent to-transparent dark:from-amber-950/20 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              />
              <Badge variant="outline" className="text-xs font-semibold px-2 sm:px-3 py-0.5 sm:py-1 bg-amber-50 dark:bg-amber-950/50 border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-300">
                Enterprise
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6 max-w-md">
              <div className="flex items-center gap-1.5 sm:gap-2 text-xs text-slate-600 dark:text-slate-400">
                <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a
                ...
                className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-primary/10 dark:hover:bg-primary/15 hover:border-primary/30 border border-transparent flex items-center justify-center transition-all duration-200 hover:scale-105"
              >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3.5">
              <li>
                <Link to="#" className="text-sm text-slate-600 dark:text-slate-400 hover:text-primary transition-colors font-medium flex items-center gap-2 group">
                  <span className="h-1 w-1 rounded-full bg-slate-300 dark:bg-slate-700 group-hover:bg-primary transition-colors" />
                  NIN Validation
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
              <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">
                © {currentYear} <span className="font-bold text-slate-900 dark:text-slate-100">Sparklabid</span>. All rights reserved.
              </p>
