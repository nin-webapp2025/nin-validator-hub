...
const actionColors: Record<string, string> = {
  role_change: "bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-300",
  modification_approved: "bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300",
  ...
  password_changed: "bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-300",
